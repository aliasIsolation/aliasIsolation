...
PSOutput main(in PSInput IN)
{
	...
	float depth = SamplerInput_TEX.SampleLevel(SamplerInput_SMP, uv, 0).x;
	depth = depth * Spotlight0_ReverseZPerspective.y + Spotlight0_ReverseZPerspective.z;
	depth = Spotlight0_ReverseZPerspective.x / depth;
	OUT.param0 = depth.xxxx;
